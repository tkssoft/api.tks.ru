...
export const przname = (prz, short=false) => {
    switch (String(prz)) {
        case "0":
            return  short ? "Пошлина" : "Экспортная пошлина";
        case "1":
            return  short ? "Пошлина" : "Импортная пошлина";
        case "2":
            return  "Акциз";
        case "3":
            return  "НДС";
        ...
        case "18":
            return  short ? "Коэффициенты пошлины" : "Особенности коэффициентов для импортной пошлины";
        case "19":
        ...
        // Экспорт
        case "21":
            return  short ? "Двойное применение" : "Товары двойного применения";
        case "22":
            return  short ? "Сборы" : "Сборы экспорт";
        case "23":
            return  short ? "Сборы" : "Сборы импорт";
        case "24":
            return  short ? "Пошлина ЕАЭС" : "Импортная пошлина стран ЕАЭС";
        case "25":
        ...
        case "31":
            return  short ? "Пошлина ЕАЭС" : "Экспортная пошлина стран ЕАЭС";
        case "32":
            return  "Преф. режим для НРС";
        case "33":
            return "Прослеживаемость";
        case "34":
            return short ? "Запреты других стран" : 'Перечень запретов других стран - экспорт';
        case "35":
            return short ? "Запреты других страны" : 'Перечень запретов других стран - импорт';
